...
class MoveUtilsTest {
    ...
    @Test
    void testMove2SanShortCastling() {
        FenFormat fen = new FenFormat("r3k2r/8/8/8/8/8/8/R3K2R w KQkq - 0 1");
        Board board = new Board(fen);
    ...
    @Test
    void testMove2SanKnightOpening() {
        FenFormat fen = new FenFormat("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1");
        Board board = new Board(fen);
    ...
    @Test
    void testMove2SanFullCoordsNeeded() {
    ...
    @Test
    void testMove2SanPromotionAndCheck() {
    ...
    @Test
    void testMove2SanPromotionAndMate() {
    ...
    @Test
    void testSan2MoveShortCaslting() {
        FenFormat fen = new FenFormat("r3k2r/8/8/8/8/8/8/R3K2R w KQkq - 0 1");
        Board board = new Board(fen);
    ...
    @Test
    void testSan2MovePromotionAndMate() {
        FenFormat fen = new FenFormat("rnb5/pp3Ppk/5nNp/b7/2B5/8/PP3PPP/R1Bq1RK1 w - - 0 17");
        Board board = new Board(fen);
    ...
    @Test
    void testSan2MovePromotionAndCheck() {
        FenFormat fen = new FenFormat("7k/3P4/8/8/8/8/8/K7 w - - 0 1");
        Board board = new Board(fen);
    ...
    @Test
    void testSan2MoveFullCoordsNeeded() {
        FenFormat fen = new FenFormat("7k/8/3Q4/8/8/Q2b4/2QQ4/K7 w - - 0 1");
        Board board = new Board(fen);
    ...
    void testPvGeneration() {
        ...
        MoveAttributes moveAttributes = new MoveAttributes(colorToMove, score, mateIn, nodes,  depth, timeMs, pv);
