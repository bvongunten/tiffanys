...
public class ChessGameTest extends BaseTest {
    ...
    public void testGetCurrentGameStatePreSet() {
        ChessGame game = new ChessGame();
        game.setGivenGameFinishedState(ChessGameState.REMIS_BY_FIFTY);
    ...
    @Test
    public void testRemisByRepetition() {
        ChessGame game = new ChessGame();
    ...
    @Test
    public void testRemisByRepetitionOfPgn() {
    ...
    @Test
    public void testFiftyMovesRuleOfFen() {
        ...
        assertGameState(game, moveState, ChessGameState.REMIS_BY_FIFTY, Side.BLACK, 61, 50, "7R/8/8/4k3/8/8/P3K3/8 b - - 50 61");

    }

    @Test
    public void testFiftyMovesRuleBreak() {
        String fen = "8/8/8/4k3/8/8/P3K2R/8 w - - 49 121";
        ...
        assertGameState(game, moveState, ChessGameState.GAME_OPEN, Side.BLACK, 61, 0, "8/8/8/4k3/8/P7/4K2R/8 b - - 0 61");
    }

    @Test
    public void testRemisByMaterial() {
