...
public enum Direction {
    ...
    static final List<Direction> KNIGHT_DIRECTIONS = new ArrayList<>();
    static final List<Direction> DIAGONAL_DIRECTIONS = new ArrayList<>();
    static final List<Direction> ORTHOGONAL_DIRECTIONS = new ArrayList<>();
