package ch.nostromo.tiffanys.engine.dragonborn.board.impl.fast;

import ch.nostromo.tiffanys.engine.dragonborn.board.RobustBoard;
import ch.nostromo.tiffanys.engine.dragonborn.board.RobustBoardPiecePositions;
...
import ch.nostromo.tiffanys.engine.dragonborn.move.impl.fast.FastMoveGenPatterns;

public class TiffanysBoardInterfaceWhite implements DragonbornConstants {
    ...
    public final void makeMoveWhite(RobustBoard board, EngineMove move) {
      ...
      //  move.stackZobristKey = board.zobristKey;
        ...
        case EngineMove.HIT_MOVE_KNIGHT: {
            ...
            case DragonbornConstants.WHITE_PAWN:
                board.whitePawnsPositions.updatePosition(move.stackFromBoardPieceIndex, move.to);
                break;
            case DragonbornConstants.WHITE_KNIGHT:
                board.whiteKnightsPositions.updatePosition(move.stackFromBoardPieceIndex, move.to);
                break;
            case DragonbornConstants.WHITE_BISHOP:
        ...
        case EngineMove.SHORT_CASTLING: {
           ...
           // board.whiteKingPos = POS_WHITE_KING_SHORT_CASTLING_END;
            ...
            board.board[POS_WHITE_KING_SHORT_CASTLING_END] = DragonbornConstants.WHITE_KING;
            ...
            board.board[POS_WHITE_ROOK_SHORT_CASTLING_END] = DragonbornConstants.WHITE_ROOK;
        ...
        case EngineMove.LONG_CASTLING: {
            ...
            board.board[POS_WHITE_KING_LONG_CASTLING_END] = DragonbornConstants.WHITE_KING;
            board.board[POS_WHITE_KING_CASTLING_START] = 0;
            ...
            board.board[POS_WHITE_ROOK_LONG_CASTLING_END] = DragonbornConstants.WHITE_ROOK;
    ...
    public final void undoMoveWhite(RobustBoard board, EngineMove move) {
        ...
        case EngineMove.SHORT_CASTLING: {
            ...
            board.board[POS_WHITE_KING_CASTLING_START] = DragonbornConstants.WHITE_KING;
            ...
            board.board[POS_WHITE_ROOK_SHORT_CASTLING_START] = DragonbornConstants.WHITE_ROOK;
        ...
        case EngineMove.LONG_CASTLING: {
            ...
            board.board[POS_WHITE_ROOK_LONG_CASTLING_START] = DragonbornConstants.WHITE_ROOK;
